...
update-alternatives --install \
	/usr/bin/ias-bash-script-infra_hello \
	ias-bash-script-infra_hello \
	/opt/IAS/bin/ias-bash-script-infra/ias-bash-script-infra_hello.sh 50
```
...
update-alternatives --remove \
	ias-bash-script-infra_hello \
	/opt/IAS/bin/ias-bash-script-infra/ias-bash-script-infra_hello.sh
```
